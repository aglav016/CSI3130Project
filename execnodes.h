...
typedef struct HashJoinState
{
	...
	HashJoinTable outer_hj_HashTable; /* CSI 3130 - name updated */
	HashJoinTable inner_hj_HashTable; /* CSI 3130 - hash table for the hashjoin of inner relation */
	uint32		outer_hj_CurHashValue; /* CSI 3130 - name updated */
	uint32		inner_hj_CurHashValue; /* CSI 3130 - hash value for current inner tuple */
	int			outer_hj_CurBucketNo; /* CSI 3130 - name updated */
	int			inner_hj_CurBucketNo; /* CSI 3130 - regular bucket# for current inner tuple */
	int			outer_hj_CurSkewBucketNo; /* CSI 3130 - name updated */
	int			inner_hj_CurSkewBucketNo; /* CSI 3130 - skew bucket# for current inner tuple */
	HashJoinTuple outer_hj_CurTuple; /* CSI 3130 - name updated */
	HashJoinTuple inner_hj_CurTuple; /* CSI 3130 - last inner tuple matched to current outer
 *										tuple in inner relation, or NULL if starting searche */
	List	   *hj_OuterHashKeys;		/* list of ExprState nodes */
	List	   *hj_InnerHashKeys;		/* list of ExprState nodes */
	List	   *hj_HashOperators;		/* list of operator OIDs */
	TupleTableSlot *hj_OuterTupleSlot; 
	TupleTableSlot *hj_InnerTupleSlot; /* CSI 3130 - tuple slot for outer tuples */
	TupleTableSlot *outer_hj_HashTupleSlot;  /* CSI 3130 - name updated */
	TupleTableSlot *inner_hj_HashTupleSlot;  /* CSI 3130 - tuple slot for hashed inner tuples */
	TupleTableSlot *hj_NullInnerTupleSlot;
	TupleTableSlot *hj_FirstOuterTupleSlot;
	bool		hj_NeedNewOuter;
	bool		hj_NeedNewInner; /* CSI 3130 - true if need new inner tuple on next call */
	bool		hj_MatchedOuter;
	bool		hj_MatchedInner; /* CSI 3130 - true if found a join match for current inner */
	bool		hj_OuterNotEmpty;
	bool		hj_InnerNotEmpty; /* CSI 3130 - true if inner relation known not empty */
} HashJoinState;
