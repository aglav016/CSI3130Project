					 ...
					 Plan *inner_plan)
{
	...
	HashJoin   *join_plan;
	Hash	   *inner_hash_plan; /* CSI 3130 - Changed name from hash_plan to inner_hash_plan */
	Hash 	   *outer_hash_plan /* CSI 3130 - Create a Hash for the outer relation the same way the inner Hash was created */
	...
	/* CSI 3130 - Create a plan for the outer hash plan exaclty how the inner hash plan was created*/
	...
	join_plan = make_hashjoin(tlist,
							  ...
							  hashclauses,
							  outer_plan,
							  /* CSI 3130 - add the outer_hash_plan the same way the inner_hash_plan was added */
							  (Plan *) outer_hash_plan;
							  /* CSI 3130 - updated hash_plan name to inner_hash_plan name*/
